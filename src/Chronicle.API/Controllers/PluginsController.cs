...
public class PluginsController : ControllerBase
{
    ...
    [
        ...
        new PluginCatalogEntry(
            ...
            Name:        "FanEdit",
            Description: "Fetches fanedit metadata from the Internet Fan Edit Database (fanedit.org). Requires a registered fanedit.org account.",
            Author:      "Chronicle Contributors",
            IconUrl:     null,
            GithubRepo:  "thegoddamnbeckster/Chronicle.Plugin.FanEdit",
            AssetName:   "Chronicle.Plugin.FanEdit.zip",
            DllName:     "Chronicle.Plugin.FanEdit.dll",
            Tags:        ["fanedits", "metadata"],
            Sha256:      "",
            Version:     "1.0.0"
        ),
        new PluginCatalogEntry(
            ...
            AssetName:   "Chronicle.Plugin.FanartTV.zip",
        ...
        new PluginCatalogEntry(
            ...
            Tags:        ["books", "audiobooks", "metadata", "import"],
            Sha256:      "",
            Version:     "1.1.3"
        ),
        new PluginCatalogEntry(
            ...
            Description: "Fetches fan edit metadata from the Movies Remastered Database (moviesremastered.com / MRDb), a community fanedit archive. No account required.",
            Author:      "Chronicle Contributors",
            IconUrl:     null,
            GithubRepo:  "thegoddamnbeckster/Chronicle.Plugin.MoviesRemastered",
            AssetName:   "Chronicle.Plugin.MoviesRemastered.zip",
        ...
        new PluginCatalogEntry(
            ...
            Name:        "SIMKL",
            Description: "Metadata for Movies, TV, and Anime from SIMKL, plus watch history/ratings/watchlist import. Requires a free SIMKL API Client ID.",
            Author:      "Chronicle Contributors",
            IconUrl:     "https://simkl.com/favicon.ico",
            GithubRepo:  "thegoddamnbeckster/Chronicle.Plugin.Simkl",
            AssetName:   "Chronicle.Plugin.Simkl.zip",
            DllName:     "Chronicle.Plugin.Simkl.dll",
            Tags:        ["movies", "tv", "anime", "metadata", "import"],
            Sha256:      "",
            Version:     "1.3.0"
        ),
        new PluginCatalogEntry(
            ...
            Name:        "TheTVDB",
            Description: "Metadata for TV series, seasons, and episodes from TheTVDB — the community standard used by Sonarr, Plex, Kodi, Trakt, and SIMKL. Requires a free TheTVDB API key.",
            Author:      "Chronicle Contributors",
            IconUrl:     null,
            GithubRepo:  "thegoddamnbeckster/Chronicle.Plugin.TheTVDB",
            AssetName:   "Chronicle.Plugin.TheTVDB.zip",
        ...
        new PluginCatalogEntry(
            ...
            Name:        "Trakt",
            Description: "Import watch history, ratings, and watchlist from Trakt.tv into Chronicle. Requires a Trakt API application -- as of 2026, creating one requires a paid Trakt VIP membership.",
            Author:      "thegoddamnbeckster",
            IconUrl:     "https://trakt.tv/favicon.ico",
            GithubRepo:  "thegoddamnbeckster/Chronicle.Plugin.Trakt",
            AssetName:   "Chronicle.Plugin.Trakt.zip",
            DllName:     "Chronicle.Plugin.Trakt.dll",
            Tags:        ["movies", "tv", "import"],
            Sha256:      "",
            Version:     "1.1.0"
        ),
        new PluginCatalogEntry(
            ...
            AssetName:   "Chronicle.Plugin.TVMaze.zip",
        ...
        new PluginCatalogEntry(
            ...
            AssetName:   "Chronicle.Plugin.Themes.Default.zip",
