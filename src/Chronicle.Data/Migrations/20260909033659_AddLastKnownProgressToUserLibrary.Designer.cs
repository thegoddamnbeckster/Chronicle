...
namespace Chronicle.Data.Migrations
{
    ...
    [Migration("20260909033659_AddLastKnownProgressToUserLibrary")]
    partial class AddLastKnownProgressToUserLibrary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chronicle.Core.Models.KodiDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.HasIndex("ApiTokenId")
                        .IsUnique()
                        .HasDatabaseName("idx_kodi_devices_api_token");

                    b.HasIndex("UserId");

                    b.ToTable("kodi_devices", (string)null);
                });

            modelBuilder.Entity("Chronicle.Core.Models.KodiLibraryId", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.HasIndex("KodiDeviceId", "MediaItemId")
                        .IsUnique()
                        .HasDatabaseName("idx_kodi_library_ids_unique");

                    b.ToTable("kodi_library_ids", (string)null);
                });
            ...
            modelBuilder.Entity("Chronicle.Core.Models.MediaCredit", b =>
                {
                    ...
                    b.HasIndex("PersonMediaItemId")
                        .HasDatabaseName("idx_media_credits_person_item");

                    b.HasIndex("PersonName")
                        .HasDatabaseName("idx_media_credits_person");

                    b.HasIndex("Role", "PersonMediaItemId")
                        .HasDatabaseName("idx_media_credits_role");
            ...
            modelBuilder.Entity("Chronicle.Core.Models.MediaItem", b =>
                {
                    ...
                    b.HasIndex("NormalizedNameLoose")
                        .HasDatabaseName("idx_media_items_normalized_name_loose");
            ...
            modelBuilder.Entity("Chronicle.Core.Models.NfoRebuildQueueItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.Property<int?>("ClaimedByKodiDeviceId")
                        .HasColumnType("INTEGER")
                        .HasColumnName("claimed_by_kodi_device_id");
                    ...
                    b.Property<DateTime?>("LastReleasedAt")
                        .HasColumnType("TEXT")
                        .HasColumnName("last_released_at");

                    b.Property<int?>("LastReleasedByKodiDeviceId")
                        .HasColumnType("INTEGER")
                        .HasColumnName("last_released_by_kodi_device_id");
                    ...
                    b.HasIndex("MediaItemId")
                        .IsUnique()
                        .HasDatabaseName("idx_nfo_rebuild_queue_media_item");

                    b.HasIndex("LastReleasedByKodiDeviceId", "LastReleasedAt")
                        .HasDatabaseName("idx_nfo_rebuild_queue_last_released");

                    b.HasIndex("CompletedAt", "ClaimedByKodiDeviceId", "LeaseExpiresAt")
                        .HasDatabaseName("idx_nfo_rebuild_queue_claimable");

                    b.ToTable("nfo_rebuild_queue", (string)null);
                });
            ...
            modelBuilder.Entity("Chronicle.Core.Models.PersonHeadshot", b =>
                {
                    ...
                    b.HasIndex("PersonMediaItemId")
                        .HasDatabaseName("idx_person_headshots_person");

                    b.HasIndex("PersonMediaItemId", "Url")
                        .IsUnique()
                        .HasDatabaseName("idx_person_headshots_unique");

                    b.ToTable("person_headshots", (string)null);
                });
            ...
            modelBuilder.Entity("Chronicle.Core.Models.KodiDevice", b =>
                {
                    b.HasOne("Chronicle.Core.Models.ApiToken", null)
                        .WithMany()
                        .HasForeignKey("ApiTokenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Chronicle.Core.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Chronicle.Core.Models.KodiLibraryId", b =>
                {
                    b.HasOne("Chronicle.Core.Models.KodiDevice", null)
                        .WithMany()
                        .HasForeignKey("KodiDeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Chronicle.Core.Models.MediaCredit", b =>
                {
                    ...
                    b.HasOne("Chronicle.Core.Models.MediaItem", "PersonMediaItem")
                        .WithMany()
                        .HasForeignKey("PersonMediaItemId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("MediaItem");

                    b.Navigation("PersonMediaItem");
                });
