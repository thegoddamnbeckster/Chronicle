...
{
    /// <inheritdoc />
    public partial class DropNfoRebuildQueue : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_released_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    last_released_by_kodi_device_id = table.Column<int>(type: "INTEGER", nullable: true),
